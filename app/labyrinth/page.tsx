...
export default function Labyrinth() {
  return (
    <div style={{ minHeight: '100vh', background: '#000', color: '#fff', fontFamily: 'Cormorant Garamond, serif', overflowX: 'hidden', scrollBehavior: 'smooth' }}>

      {/* Entry Hall */}
      <section id="top" style={{ height: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', position: 'relative', background: 'linear-gradient(to bottom, #000, #0d0d2b)' }}>
        <div style={{ maxWidth: '800px', textAlign: 'center', zIndex: 10, padding: '0 2rem' }}>
          ...
          <p style={{ fontSize: '1.4rem', marginBottom: '3rem', color: '#c9a84c', fontStyle: 'italic' }}>
            Step through — truth hides in beauty.
          </p>
          <a href="#room-origins" style={{ display: 'inline-block', padding: '1.2rem 3rem', border: '1px solid #c9a84c', color: '#c9a84c', fontSize: '0.85rem', fontFamily: 'Cinzel, serif', letterSpacing: '0.2em', textDecoration: 'none', transition: 'all 0.3s' }}>
            OPEN THE FIRST DOOR
          </a>
        </div>
        <div style={{ position: 'absolute', inset: 0, background: 'radial-gradient(ellipse at center, #1a1a3e 0%, #000 70%)', opacity: 0.6 }} />
      </section>
      ...
      <section id="room-origins" style={{ padding: '7rem 2rem', maxWidth: '900px', margin: '0 auto' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '1.5rem', marginTop: '3rem' }}>
          {['The Golden Void', 'Inverted Divine', 'Cosmic Chaos'].map(title => (
            <div key={title} style={{ aspectRatio: '3/2', background: 'linear-gradient(135deg, #111, #1a1a0a)', border: '1px solid #c9a84c33', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '1rem' }}>
              <div style={{ textAlign: 'center' }}>
                ...
                <div style={{ fontFamily: 'Cinzel, serif', fontSize: '7px', letterSpacing: '0.1em', color: '#c9a84c', opacity: 0.4, marginTop: '0.5rem' }}>GOD SERIES</div>
              </div>
            </div>
          ))}
        </div>
